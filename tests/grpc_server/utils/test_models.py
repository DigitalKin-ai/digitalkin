...
class TestEnums:
    ...
    def test_server_mode_enum(self) -> None:
        ...
        # Check SYNC value
        assert CommunicationMode.SYNC == "sync"

        # Check ASYNC value
        assert CommunicationMode.ASYNC == "async"

        # Check all enum members
        expected_members = [CommunicationMode.SYNC, CommunicationMode.ASYNC]
        actual_members = list(CommunicationMode)
...
class TestServerConfig:
    ...
    def test_server_config_defaults(self) -> None:
        ...
        # Check mode
        assert config.channel.communication_mode == CommunicationMode.ASYNC
        # Check security
