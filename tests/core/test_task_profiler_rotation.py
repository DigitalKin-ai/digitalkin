...
def test_pyinstrument_save_triggers_rotation(tmp_path: Path, monkeypatch: "pytest.MonkeyPatch") -> None:
    """End-to-end: TaskProfiler.stop in PYINSTRUMENT mode invokes rotation."""
    import pytest  # noqa: F401  -- used by the type annotation above
    ...
    monkeypatch.setenv("DIGITALKIN_PROFILER_KEEP_N", "3")
