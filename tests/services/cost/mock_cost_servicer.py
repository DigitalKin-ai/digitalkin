...
from digitalkin.services.cost import CostType, CostData
...
class MockCostServicer(cost_service_pb2_grpc.CostServiceServicer):
    ...
    def CreateCost(self, request: cost_dto_pb2.CreateCostRequest, context: grpc.ServicerContext) -> cost_dto_pb2.CreateCostResponse:
        ...
        try:
            ...
            return cost_dto_pb2.CreateCostResponse(success=False)
    ...
    def ListCosts(self, request: cost_dto_pb2.ListCostsRequest, context: grpc.ServicerContext) -> cost_dto_pb2.ListCostsResponse:
        ...
        try:
            ...
            items_results = bulk_pb2.ItemResult(error=bulk_pb2.OperationError(code=grpc.StatusCode.INTERNAL, message="Error in GetCosts"))
            bulk = bulk_pb2.BulkResponse(results=[items_results], total_process=total_cost, total_failed=total_cost)
            return cost_dto_pb2.ListCostsResponse(bulk=bulk)
