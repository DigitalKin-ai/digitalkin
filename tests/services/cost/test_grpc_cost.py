...
class TestListCost:
    ...
    def test_get_costs_by_types(
        ...
        future_get = thread_pool.submit(asyncio.run, client.list(cost_types=["TOKEN_INPUT", "TOKEN_OUTPUT"]))
    ...
    def test_get_costs_by_names_and_types(
        ...
        future_get = thread_pool.submit(asyncio.run, client.list(names=["cost_a", "cost_d"], cost_types=["TOKEN_INPUT"]))
