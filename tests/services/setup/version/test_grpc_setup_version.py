...
from tests.fixtures.grpc_fixtures import AsyncStubWrapper
...
def client(test_channel: grpc_testing.Channel) -> GrpcSetup:
    ...
    client.stub = AsyncStubWrapper(setup_version_service_pb2_grpc.SetupVersionServiceStub(test_channel))
    return client
...
class TestCreateSetupVersion:
    ...
    def test_create_setup_version_validation_error(
        ...
        with pytest.raises(SetupVersionServiceError, match="Unexpected error in Setup Version Creation"):
            future.result()
