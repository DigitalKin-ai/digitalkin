...
from digitalkin.services.setup.setup_models import SetupVersionData, SetupData
...
class TestCreateSetup:
    ...
    def test_create_setup_request_creation_success(
        ...
        model_dump = generate_setup_obj.model_dump()
        future = thread_pool.submit(client.create, model_dump)
    ...
    def test_create_setup_success(
        ...
        """
        # Start the client call (this call will block until the response is simulated).
        future = thread_pool.submit(client.create, generate_setup_obj.model_dump())
...
class TestGetSetup:
    ...
    def test_get_setup_success(
        ...
        create_future = thread_pool.submit(client.create, generate_setup_obj.model_dump())
        ...
        # Now get the setup
        get_future = thread_pool.submit(client.get, {"setup_id": created_setup_id})
    ...
    def test_get_setup_not_found(
        ...
        get_future = thread_pool.submit(client.get, {"setup_id": "nonexistent_id"})
        _, get_request, get_rpc = test_channel.take_unary_unary(get_method_desc)
...
class TestUpdateSetup:
    ...
    def test_update_setup_success(
        ...
        update_future = thread_pool.submit(client.update, updated_data)
...
class TestDeleteSetup:
    ...
    def test_delete_setup_success(
        ...
        # Delete the setup
        delete_future = thread_pool.submit(client.delete, {"setup_id": created_setup_id})
    ...
    def test_delete_setup_not_found(
        ...
        delete_future = thread_pool.submit(client.delete, {"setup_id": "nonexistent_id"})
        _, delete_request, delete_rpc = test_channel.take_unary_unary(delete_method_desc)
...
class TestListSetups:
    ...
    def test_list_setups_success(
        ...
        list_future = thread_pool.submit(client.list, {})
    ...
    def test_list_setups_with_pagination(
        ...
        # List first 2 setups
        list_method_desc = service_desc.methods_by_name["ListSetups"]
        list_future = thread_pool.submit(client.list, {"limit": 2, "offset": 0})
        _, list_request, list_rpc = test_channel.take_unary_unary(list_method_desc)
        ...
        list_future2 = thread_pool.submit(client.list, {"limit": 2, "offset": 2})
