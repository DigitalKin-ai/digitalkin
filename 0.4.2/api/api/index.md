...
- #### **`config_setup_data`**
  ...
  (`dict[str, Any]`) – The setup data to create the model from.

Returns:

- `SetupModelT` – The setup model.
...
- #### **`input_data`**
  ...
  (`dict[str, Any]`) – The input data to create the model from.

Returns:

- `DataModel` – The input model, validated against the extended format that
- `DataModel` – includes SDK utility protocols (healthcheck, etc.).
...
- #### **`output_data`**
  ...
  (`dict[str, Any]`) – The output data to create the model from.

Returns:

- `OutputModelT` – The output model.
...
- #### **`secret_data`**
  ...
  (`dict[str, Any]`) – The secret data to create the model from.

Returns:

- `SecretModelT` – The secret model.
...
- #### **`config_fields`**
  ...
  (`bool`, default: `False` ) – If True, include only fields with json_schema_extra["config"] == True.
...
- #### **`llm_format`**
  ...
  (`bool`) – If True, return LLM-optimized schema format with inlined references and simplified structure.
...
- `str` – The JSON schema with json_schema and ui_schema keys as a JSON string,
- `str` – or empty object if no select_format is defined.
...
- #### **`handler_cls`**
  ...
  (`type[TriggerHandler]`) – type of the trigger handler to register.
...
- #### **`input_data`**
  ...
  (`InputModelT`) – Input data to process.

- #### **`setup_data`**

  (`SetupModelT`) – Configuration data for the module.
...
- #### **`config_setup_data`**
  ...
  (`SetupModelT`) – Initial setup data to configure.

- #### **`callback`**

  (`Callable[[SetupModelT | ModuleCodeModel], Coroutine[Any, Any, None]]`) – Callback to send the configured setup model.
...
- ### **`helpers`**
  ...
  (`dict[str, Any] | None`, default: `None` ) – dict different user defined helpers.

- ### **`session`**

  (`dict[str, Any]`) – dict referring the session IDs or informations.

- ### **`callbacks`**

  (`dict[str, Any] | None`, default: `None` ) – Functions allowing user to agent interaction.

- ### **`tool_cache`**

  (`ToolCache | None`, default: `None` ) – ToolCache with pre-resolved tool references from setup.
...
- #### **`setup_id`**
  ...
  (`str`) – Setup ID to look up (checks cache first, then registry).

Returns:

- `list[dict[str, Any]]` – List of OpenAI-style tool schemas, one per protocol. Empty if not found.
...
- #### **`slug`**
  ...
  (`str`) – Setup ID to look up in cache.
...
- #### **`module_id`**
  ...
  (`str`) – Module identifier to look up in registry.

- #### **`llm_format`**

  (`bool`, default: `False` ) – If True, return LLM-optimized schema format.
...
- ### **`services_config_strategies`**
  ...
  (`dict[str, ServicesStrategy | None]`, default: `{}` ) – Dictionary mapping service names to strategy implementations

- ### **`services_config_params`**

  (`dict[str, dict[str, Any | None] | None]`, default: `{}` ) – Dictionary mapping service names to configuration parameters

- ### **`mode`**

  (`ServicesMode`, default: `LOCAL` ) – The mode of the services (local or remote)

- ### **`**kwargs`**

  (`dict[str, Any]`, default: `{}` ) – Additional keyword arguments passed to the parent class constructor
...
- #### **`name`**
  ...
  (`str`) – The name of the strategy to retrieve the configuration for

Returns:

- `dict[str, Any]` – The configuration for the specified strategy, or empty dict if not found
...
- #### **`name`**
  ...
  (`str`) – The name of the strategy to initialize
...
- #### **`setup_id`**
  ...
  (`str`) – The setup ID for the strategy

- #### **`setup_version_id`**

  (`str`) – The setup version ID for the strategy
...
- #### **`mode`**
  ...
  (`ServicesMode`) – The new mode to use for all strategies
...
- `set[str]` – The set of valid strategy names.
...
- #### **`context`**
  ...
  (`ModuleContext`) – Module context containing the cost strategy.

- #### **`name`**

  (`str`) – Name/identifier for this cost entry.

- #### **`cost_config_name`**

  (`str`) – Name of the cost configuration to use.
...
```python
get_cost(context: ModuleContext, name: str) -> list[CostData]
```
...
- #### **`name`**
  ...
  (`str`) – Name/identifier to get costs for.

Returns:

- `list[CostData]` – List of cost data entries, empty on failure.
...
- #### **`names`**
  ...
  (`list[str] | None`, default: `None` ) – Optional list of names to filter by.

- #### **`cost_types`**

  (`list[Literal['TOKEN_INPUT', 'TOKEN_OUTPUT', 'API_CALL', 'STORAGE', 'TIME', 'OTHER']] | None`, default: `None` ) – Optional list of cost types to filter by.
...
- #### **`input_data`**
  ...
  (`InputModelT`) – The input data to be processed by the handler.

- #### **`setup_data`**

  (`SetupModelT`) – The setup or configuration data required for processing.

- #### **`context`**

  (`ModuleContext`) – The context object containing module-specific information and resources.
...
- ###### **`agno_event`**
  ...
  (`AgnoRunEvent`) – Event from Agno's streaming API.
...
- ###### **`module_class`**
  ...
  (`type[BaseModule]`) – The module class to instantiate
...
- ###### **`services_mode`**
  ...
  (`ServicesMode`) – The mode of operation for the services (e.g., ASYNC or SYNC).

- ###### **`task_manager`**

  (`BaseTaskManager`) – The task manager instance to use for task lifecycle management.
...
- ###### **`output_data`**
  ...
  (`DataModel | ModuleCodeModel`) – The output data produced by the job.
...
- ##### **`task_id`**
  ...
  (`str`) – Unique identifier for the task being profiled.

- ##### **`mode`**

  (`ProfilerMode`) – Which profiler backend to use.

- ##### **`output_dir`**

  (`str`) – Directory to write profiling output files.

Methods:

- **`start`** – Start the profiler. No-op when mode is NONE.
- **`stop`** – Stop the profiler, log summary, and save output. No-op when mode is NONE.
...
- ###### **`exc_type`**
  ...
  (`type[BaseException] | None`) – Exception type if an exception occurred

- ###### **`exc_val`**

  (`BaseException | None`) – Exception value if an exception occurred

- ###### **`exc_tb`**

  (`TracebackType | None`) – Exception traceback if an exception occurred
...
- ###### **`mission_id`**
  ...
  (`str`) – The ID of the mission

- ###### **`timeout`**

  (`float | None`, default: `None` ) – Optional timeout for cancellation

Returns:

- `dict[str, bool | BaseException]` – Dictionary mapping task_id to cancellation success status
...
- ###### **`task_id`**
  ...
  (`str`) – The ID of the task to cancel
...
- `bool` – True if the task session was cleaned successfully, False otherwise.
...
- ###### **`module`**
  ...
  (`BaseModule`) – Module instance to execute
...
- ###### **`default_timeout`**
  ...
  (`float`, default: `10.0` ) – Default timeout for task operations in seconds
...
- ###### **`module`**
  ...
  (`BaseModule`) – Module instance for metadata (not executed here)

- ###### **`coro`**

  (`Coroutine[Any, Any, None]`) – Coroutine (will be closed - execution happens in worker)
...
- ###### **`request`**
  ...
  (`ConfigSetupModuleRequest`) – The configuration request.
...
- ###### **`request`**
  ...
  (`GetConfigSetupModuleRequest`) – The get module setup request.
...
- `GetConfigSetupModuleResponse` – A response with the module's setup information.
...
- ###### **`request`**
  ...
  (`GetModuleCostRequest`) – The get module cost request.
...
- `GetModuleCostResponse` – A response with the module's cost schema.
...
- ###### **`request`**
  ...
  (`GetModuleInputRequest`) – The get module input request.
...
- `GetModuleInputResponse` – A response with the module's input schema.
...
- ###### **`request`**
  ...
  (`GetModuleOutputRequest`) – The get module output request.
...
- `GetModuleOutputResponse` – A response with the module's output schema.
...
- ###### **`request`**
  ...
  (`GetModuleSecretRequest`) – The get module secret request.
...
- `GetModuleSecretResponse` – A response with the module's secret schema.
...
- ###### **`request`**
  ...
  (`GetModuleSelectInputRequest`) – The get module select input request.
...
- `GetModuleSelectInputResponse` – A response with the module's select input schema.
...
- ###### **`request`**
  ...
  (`GetModuleSetupRequest`) – The get module setup request.
...
- ###### **`base_model`**
  ...
  (`type[DataModel]`) – The module's input_format class (a DataModel subclass).

Returns:

- `type[DataModel]` – A new DataModel subclass with root typed as Union[original_types, utility_types],
- `type[DataModel]` – and includes cost_limits field for cost control.

###### create_extended_output_model
...
- ###### **`base_model`**
  ...
  (`type[DataModel]`) – The module's output_format class (a DataModel subclass).
...
- #### **`is_production`**
  ...
  (`bool`, default: `False` ) – Whether the application is running in production.
...
- ##### **`context`**
  ...
  (`ModuleContext`) – Module context containing the filesystem strategy
...
- ##### **`files`**
  ...
  (`list[Any]`) – List of files to upload
...
- `list[tuple[str, Any]]` – Full list of gRPC channel options.
...
- ###### **`v`**
  ...
  (`ClientCredentials | None`) – The credentials value
...
- ##### **`raw`**
  ...
  (`dict[str, str] | None`, default: `None` ) – Dictionary of metadata key-value pairs. Keys prefixed with grpc- are filtered out.
...
- `str | None` – The token string if the Authorization header starts with Bearer, otherwise None.
...
- ###### **`default`**
  ...
  (`str | None`, default: `None` ) – Default value if key is not found.

Returns:

- `str | None` – The metadata value or default.
...
- `list[tuple[str, str]]` – List of (key, value) tuples suitable for gRPC metadata= parameter.
...
- ###### **`protocols_info`**
  ...
  (`dict[str, str]`) – Dict mapping protocol name to description.

Returns:

- `dict[str, Any] | None` – Dict with json_schema and ui_schema keys, or None to exclude.
...
- ###### **`registry`**
  ...
  (`RegistryStrategy | None`, default: `None` ) – Registry service for resolving uncached tools.

- ###### **`communication`**

  (`CommunicationStrategy | None`, default: `None` ) – Communication service for module schemas.
...
- ###### **`config_fields`**
  ...
  (`bool`) – Include fields with json_schema_extra["config"] = True.
...
- ###### **`force`**
  ...
  (`bool`, default: `False` ) – Refresh dynamic schema fields by calling providers.
...
- ###### **`registry`**
  ...
  (`RegistryStrategy`) – Registry service for module discovery.
...
- `tuple` – Tuple of TriggerHandler subclasses for built-in functionality.
...
- ##### **`setup_ids`**
  ...
  (`list[str] | None`, default: `None` ) – Setup IDs for the user to choose from.

- ##### **`module_ids`**

  (`list[str] | None`, default: `None` ) – Module IDs for the user to choose from.

- ##### **`tag_ids`**

  (`list[str] | None`, default: `None` ) – Tag IDs for the user to choose from.

- ##### **`categories`**

  (`list[str] | None`, default: `None` ) – Categories for the user to choose from.

- ##### **`max_tools`**

  (`int`, default: `0` ) – Maximum tools allowed. 0 for unlimited.

- ##### **`min_tools`**

  (`int`, default: `0` ) – Minimum tools required. 0 for no minimum.
...
- `dict[str, str]` – A dictionary containing the current session ids.

#### module_types

Types for module models - backward compatibility re-exports.

This module re-exports types from their new locations for backward compatibility. New code should import directly from the specific modules:
...
- ###### **`input_data`**
  ...
  (`HealthcheckPingInput`) – The input trigger data (unused for healthcheck).

- ###### **`setup_data`**

  (`Any`) – The setup configuration (unused for healthcheck).
...
- ###### **`input_data`**
  ...
  (`HealthcheckServicesInput`) – The input trigger data (unused for healthcheck).
...
- ###### **`input_data`**
  ...
  (`HealthcheckStatusInput`) – The input trigger data (unused for healthcheck).
...
- ##### **`llm_format`**
  ...
  (`bool`, default: `False` ) – Return LLM-friendly format (simplified schema). Note: cost always returns actual data regardless of this flag.

Returns:

- `dict[str, dict]` – Dictionary containing schemas:
- `dict[str, dict]` – { "input": {...}, "output": {...}, "setup": {...}, "secret": {...}, "cost": {...}
- `dict[str, dict]` – }
...
- ##### **`cost_config_name`**
  ...
  (`str`) – Name of the cost config.

- ##### **`quantity`**

  (`float`) – Quantity to add.
...
- ##### **`configs`**
  ...
  (`list[CostConfig]`) – List of CostConfig objects to store.
...
- #### **`config`**
  ...
  (`dict[str, CostConfig]`) – The configuration dictionary for the cost
...
- ##### **`cost_config_name`**
  ...
  (`str`) – The name of the cost config

- ##### **`quantity`**

  (`float`) – The quantity of the cost
...
- `list[CostData]` – list\[CostData\]: The cost data
...
- ##### **`names`**
  ...
  (`list[str] | None`, default: `None` ) – The names of the costs

- ##### **`cost_types`**

  (`list[Literal['TOKEN_INPUT', 'TOKEN_OUTPUT', 'API_CALL', 'STORAGE', 'TIME', 'OTHER']] | None`, default: `None` ) – The types of the costs

Returns:

- `list[CostData]` – list\[CostData\]: The list of records
...
- ##### **`filters`**
  ...
  (`FileFilter`) – Filter criteria for the files to delete

- ##### **`permanent`**

  (`bool`, default: `False` ) – Whether to permanently delete the files

- ##### **`force`**

  (`bool`, default: `False` ) – Whether to force delete even if files are in use
...
- ##### **`file_id`**
  ...
  (`str`) – The ID of the file to be retrieved
...
- ##### **`include_content`**
  ...
  (`bool`, default: `False` ) – Whether to include file content in response
...
- ##### **`filters`**
  ...
  (`FileFilter`) – Filter criteria for the files

- ##### **`list_size`**

  (`int`, default: `100` ) – Number of files to return per page

- ##### **`offset`**

  (`int`, default: `0` ) – Offset to start listing files from

- ##### **`order`**

  (`str | None`, default: `None` ) – Fields to order results by (example: "created_at:asc,name:desc")
...
- ##### **`file_id`**
  ...
  (`str`) – The id of the file to be updated

- ##### **`content`**

  (`bytes | None`, default: `None` ) – Optional new content of the file

- ##### **`file_type`**

  (`Literal['UNSPECIFIED', 'DOCUMENT', 'IMAGE', 'VIDEO', 'AUDIO', 'ARCHIVE', 'CODE', 'OTHER'] | None`, default: `None` ) – Optional new type of data

- ##### **`content_type`**

  (`str | None`, default: `None` ) – Optional new MIME type

- ##### **`metadata`**

  (`dict[str, Any] | None`, default: `None` ) – Optional new metadata (will merge with existing)

- ##### **`new_name`**

  (`str | None`, default: `None` ) – Optional new name for the file
...
- ##### **`files`**
  ...
  (`list[UploadFileData]`) – List of files to upload
...
- ##### **`module_id`**
  ...
  (`str`) – The module identifier to deregister.
...
- ##### **`collection`**
  ...
  (`str`) – The unique name to retrieve data for
...
- ##### **`record_id`**
  ...
  (`str | None`) – The unique ID for the record (optional)
...
- #### **`config`**
  ...
  (`dict[str, Any] | None`, default: `None` ) – Configuration for the filesystem strategy
...
- ##### **`order`**
  ...
  (`str | None`, default: `None` ) – Field to order results by
...
- ##### **`files`**
  ...
  (`list[UploadFileData]`) – List of tuples containing (content, name, file_type, content_type, metadata, replace_if_exists)
...
- #### **`config`**
  ...
  (`dict[str, type[BaseModel]]`) – A dictionary mapping names to Pydantic model classes
...
- **`CostData`** ( `list[CostData]` ) – The cost data
...
- ##### **`client_config`**
  ...
  (`ClientConfig`) – Configuration for the gRPC client connection
...
- ###### **`offset`**
  ...
  (`int`, default: `0` ) – Offset to start from
...
- ##### **`module_id`**
  ...
  (`str`) – The ID of the module that was not found.
...
- ###### **`module_id`**
  ...
  (`str`) – The ID of the module that already exists.
...
- ###### **`mode`**
  ...
  (`str`) – The mode to get the strategy for.

Returns:

- `type[T]` – The strategy based on the mode.
...
- ##### **`mission_id`**
  ...
  (`str`, default: `''` ) – Mission identifier (unused, required by init_strategy convention).

- ##### **`setup_id`**

  (`str`, default: `''` ) – Setup identifier (unused, required by init_strategy convention).

- ##### **`setup_version_id`**

  (`str`, default: `''` ) – Setup version identifier (unused, required by init_strategy convention).
...
- #### **`trigger`**
  ...
  (`str`) – Name of the field that controls visibility.
...
- ##### **`handler`**
  ...
  (`GetJsonSchemaHandler`) – The JSON schema handler for resolving refs.
...
- **`__eq__`** – Check equality based on fetchers.
- **`__hash__`** – Hash based on fetcher keys (fetchers themselves aren't hashable).
...
- `bool` – True if fetchers are equal, NotImplemented for non-DynamicField types.
...
- `int` – Hash value based on sorted fetcher keys.
...
- **`args`** (`Namespace`) – Override methods
...
- ###### **`value`**
  ...
  (`JsonSchemaValue`) – The schema value to sort.

- ###### **`parent_key`**

  (`str | None`, default: `None` ) – The parent key of the schema value.
...
- ##### **`packages`**
  ...
  (`list[str]`) – List of package names to scan.

- ##### **`file_pattern`**

  (`str`, default: `'*_trigger.py'` ) – Glob pattern for matching modules.

- ##### **`max_file_size`**

  (`int`, default: `1024 * 1024` ) – Limit for module file sizes in bytes.
...
- ###### **`exclude_utility`**
  ...
  (`bool`, default: `False` ) – If True, exclude SDK utility protocols (healthcheck, etc.).

Returns:

- `dict[str, str]` – Dict mapping protocol name to description (from handler description attribute).
...
- ###### **`protocol`**
  ...
  (`str`) – The protocol name (ignored internally, input_instance.protocol is used instead).

- ###### **`input_instance`**

  (`DataTrigger`) – The input trigger instance used to determine the correct handler.
...
- ###### **`context`**
  ...
  (`ModuleContext`) – Module context to pass to each handler constructor.
...
- ###### **`handler_cls`**
  ...
  (`type[TriggerHandler]`) – The trigger handler class to register.
...
- **`split`** – Split schema into (jsonschema, uischema).

##### split

```python
split(combined_schema: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]
```
...
- ###### **`combined_schema`**
  ...
  (`dict[str, Any]`) – Combined JSON schema with ui:\* properties.
