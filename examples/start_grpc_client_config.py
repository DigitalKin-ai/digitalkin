...
async def discover_module(
    ...
    registry_stub = registry_service_pb2_grpc.ModuleRegistryServiceStub(registry_channel)
...
async def run_client_llm() -> None:
    ...
    async with grpc.aio.insecure_channel("localhost:50052") as registry_channel:
        ...
        logger.info("Found module: %s (ID: %s)", module.metadata.name, module.id, extra={"module_info": module})
        ...
        async with grpc.aio.insecure_channel("localhost:50055") as module_channel:
            ...
            config_setup_request = module_dto_pb2.GetConfigSetupModuleRequest(module_id=module.id)
