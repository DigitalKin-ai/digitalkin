...
class DefaultStorage(StorageStrategy):
    ...
    async def update(self, collection: str, record_id: str, data: BaseModel) -> StorageRecord | None:
        """Update a record in local JSON storage.

        Returns:
            The updated record, or None.
        """
    ...
    async def delete(self, collection: str, record_id: str) -> bool:
        """Delete a record from local JSON storage.
    ...
    async def create(
        ...
        """Create a record in local JSON storage.
