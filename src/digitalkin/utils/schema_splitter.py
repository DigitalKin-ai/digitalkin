...
class SchemaSplitter:
    ...
    @classmethod
    def _extract_ui_properties(  # Complex: recursive traversal of nested JSON schema structures # ruff: ignore[complex-structure, too-many-branches]
        cls,
        source: dict[str, Any],
    ...
    @classmethod
    def _process_object(  # Complex: JSON schema node splitting into json/ui # ruff: ignore[complex-structure, too-many-branches, too-many-statements]
        cls,
        source: dict[str, Any],
    ...
    @classmethod
    def _process_property(  # Complex: recursive property splitting with $ref resolution # ruff: ignore[complex-structure, too-many-branches]
        cls,
        source: dict[str, Any],
        json_target: dict[str, Any],
        ui_target: dict[str, Any],
    ...
    @classmethod
    def _strip_ui_properties(  # ruff: ignore[complex-structure, too-many-branches]
