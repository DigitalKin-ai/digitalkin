...
class RegistryServicer(module_registry_service_pb2_grpc.ModuleRegistryServiceServicer):
    ...
    def GetModuleStatus(  # noqa: N802
        ...
        return status_pb2.ModuleStatusResponse(module_id=module.module_id, status=module.status.value)  # type: ignore[arg-type]
    ...
    def ListModuleStatus(  # noqa: N802
        ...
        modules_statuses = [
            status_pb2.ModuleStatusResponse(module_id=module.module_id, status=module.status.value)  # type: ignore[arg-type]
    ...
    def GetAllModuleStatus(  # noqa: N802
        ...
        for module in self.registered_modules.values():
            yield status_pb2.ModuleStatusResponse(
                ...
                status=module.status.value,  # type: ignore[arg-type]
            )
