...
class Credentials(BaseModel):
    ...
    key_path: Path | None = Field(None, description="Path to the private key")
    cert_path: Path | None = Field(None, description="Path to the certificate")
...
class BaseChannelSettings(BaseSettings):
    ...
    communication_mode: CommunicationMode = Field(
        CommunicationMode.ASYNC, description="Client/Server operation mode (sync/async)"
    )
