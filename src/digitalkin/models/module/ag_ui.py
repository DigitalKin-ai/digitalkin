...
# ── AG-UI text message event outputs ─────────────────────────────────────────


class AgUiTextMessageStartOutput(AgUiDataTrigger):
    """AG-UI TextMessageStart event - signals start of a text message."""

    protocol: Literal["agui_text_message_start"] = "agui_text_message_start"  # type: ignore[misc]
...
class AgUiTextMessageContentOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_text_message_content"] = "agui_text_message_content"  # type: ignore[misc]
...
class AgUiTextMessageEndOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_text_message_end"] = "agui_text_message_end"  # type: ignore[misc]
...
class AgUiTextMessageChunkOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_text_message_chunk"] = "agui_text_message_chunk"  # type: ignore[misc]
    event: TextMessageChunkEvent = Field(..., description="AG-UI TextMessageChunk event payload")


# ── AG-UI thinking text message event outputs ─────────────────────────────────
...
class AgUiThinkingTextMessageStartOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_thinking_text_message_start"] = "agui_thinking_text_message_start"  # type: ignore[misc]
...
class AgUiThinkingTextMessageContentOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_thinking_text_message_content"] = "agui_thinking_text_message_content"  # type: ignore[misc]
...
class AgUiThinkingTextMessageEndOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_thinking_text_message_end"] = "agui_thinking_text_message_end"  # type: ignore[misc]
    event: ThinkingTextMessageEndEvent = Field(..., description="AG-UI ThinkingTextMessageEnd event payload")


# ── AG-UI tool call event outputs ─────────────────────────────────────────────


class AgUiToolCallStartOutput(AgUiDataTrigger):
    """AG-UI ToolCallStart event - signals start of a tool invocation."""

    protocol: Literal["agui_tool_call_start"] = "agui_tool_call_start"  # type: ignore[misc]
...
class AgUiToolCallArgsOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_tool_call_args"] = "agui_tool_call_args"  # type: ignore[misc]
...
class AgUiToolCallEndOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_tool_call_end"] = "agui_tool_call_end"  # type: ignore[misc]
...
class AgUiToolCallChunkOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_tool_call_chunk"] = "agui_tool_call_chunk"  # type: ignore[misc]
...
class AgUiToolCallResultOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_tool_call_result"] = "agui_tool_call_result"  # type: ignore[misc]
    event: ToolCallResultEvent = Field(..., description="AG-UI ToolCallResult event payload")


# ── AG-UI state and message snapshot outputs ──────────────────────────────────


class AgUiStateSnapshotOutput(AgUiDataTrigger):
    """AG-UI StateSnapshot event - full agent state snapshot."""

    protocol: Literal["agui_state_snapshot"] = "agui_state_snapshot"  # type: ignore[misc]
...
class AgUiStateDeltaOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_state_delta"] = "agui_state_delta"  # type: ignore[misc]
...
class AgUiRunFinishedOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_run_finished"] = "agui_run_finished"  # type: ignore[misc]
...
class AgUiReasoningMessageStartOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_reasoning_message_start"] = "agui_reasoning_message_start"  # type: ignore[misc]
...
class AgUiReasoningMessageContentOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_reasoning_message_content"] = "agui_reasoning_message_content"  # type: ignore[misc]
...
class AgUiReasoningMessageEndOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_reasoning_message_end"] = "agui_reasoning_message_end"  # type: ignore[misc]
...
class AgUiReasoningMessageChunkOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_reasoning_message_chunk"] = "agui_reasoning_message_chunk"  # type: ignore[misc]
...
class AgUiReasoningEndOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_reasoning_end"] = "agui_reasoning_end"  # type: ignore[misc]
...
class AgUiCustomEventOutput(AgUiDataTrigger):
    ...
    protocol: Literal["agui_custom"] = "agui_custom"  # type: ignore[misc]
...
# ── Root output discriminated union ───────────────────────────────────────────
